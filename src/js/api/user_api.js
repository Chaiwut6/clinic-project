const fetchAppointments = async () => {
  try {
    const response = await axios.post('https://clinic-project-w900.onrender.com/api/students/appointment', null, {
...
const fetchNotifications = async () => {
  ...
  const updateStatus = async (Appointment_id, status) => {
    try {
      ...
      const response = await axios.post('https://clinic-project-w900.onrender.com/api/students/update-appointment', {
